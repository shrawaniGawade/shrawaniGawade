...
parts.append(centered(picture('hero','Shrawani Gawade — Developer, with a curious mind. The sentence ending types and erases curious mind, creative spark and love for automation. A little code. A lot of curiosity.')))
sections=[
